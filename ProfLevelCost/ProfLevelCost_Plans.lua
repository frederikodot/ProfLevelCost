...
table.insert(ProfLevelCostPlans, {
	name = "Alchemy Optimizer 1-300 - Pool Based",
	poolKey = { "AL_PRE" },
	from = 1,
	to = 300,
	chunk = 1,
...
table.insert(ProfLevelCostPlans, {
	name = "Alchemy Optimizer 300-375 - Pool Based",
...
table.insert(ProfLevelCostPlans, {
	name = "Blacksmithing Optimizer 1-300 - Pool Based",
	poolKey = { "BS_PRE" },
	from = 1,
	to = 300,
	chunk = 1,
...
table.insert(ProfLevelCostPlans, {
	name = "Blacksmithing Optimizer 300-375 - Pool Based",
	poolKey = { "BS_PRE", "BS_OUT" },
	from = 300,
	to = 375,
	chunk = 1,
})
...
table.insert(ProfLevelCostPlans, {
	name = "Engineering Optimizer 1-300 - Pool Based",
	poolKey = { "EN_PRE" },
	from = 1,
	to = 300,
	chunk = 1,
...
table.insert(ProfLevelCostPlans, {
	name = "Engineering Optimizer 300-375 - Pool Based",
...
-- Pool-based plans (requires ProfLevelCost Core that supports poolKey as a list)
table.insert(ProfLevelCostPlans, {
	name = "Jewelcrafting Optimizer 1-300 - Pool Based",
	poolKey = { "JC_PRE" },
	from = 1,
	to = 300,
	chunk = 1,
...
table.insert(ProfLevelCostPlans, {
	name = "Jewelcrafting Optimizer 300-375 - Pool Based",
...
-- Pool-based plans (requires ProfLevelCost Core that supports poolKey as a list)
table.insert(ProfLevelCostPlans, {
	name = "Leatherworking Optimizer 1-300 - Pool Based",
	poolKey = { "LW_PRE" },
	from = 1,
	to = 300,
	chunk = 1,
...
table.insert(ProfLevelCostPlans, {
	name = "Leatherworking Optimizer 300-375 - Pool Based",
...
table.insert(ProfLevelCostPlans, {
	name = "Tailoring Optimizer 1-300 - Pool Based",
	poolKey = { "TL_PRE" },
	from = 1,
	to = 300,
	chunk = 1,
...
table.insert(ProfLevelCostPlans, {
	name = "Tailoring Optimizer 300-375 - Pool Based",
